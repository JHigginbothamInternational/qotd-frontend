...
export default class Quote extends Component {
    ...
    componentDidMount() {
        const getQuote = async () => {
            ...
            await fetch("https://qotd-jrh.herokuapp.com/date/get")
            ...
            if (dateData.day !== now.getUTCDate()) {
                ...
                await fetch("https://qotd-jrh.herokuapp.com/date/update", {
                    method: "PUT",
                ...
                .then(response => response.json())
                .then(date => dateData = data)
                .catch(error => console.log("Error updating date: ", error))
            }

            fetch(`https://qotd-jrh.herokuapp.com/quote/get/${dateData.quote}`)
            .then(response => response.json())
